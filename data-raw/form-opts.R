...
gender <- list(male = "1", female = "2", "1" = "1", "2" = "2")
...
opts_creators <- list(
  ...
  "birth_country_id" = origin, "death_country_id" = origin, "gender" = gender
)

opts_titles <- list(

  "type[]" = c(type, list(compilation = "14", "video kompilace" = "14")),
  ...
  origin = origin, genre = genre, fields = fields
)
...
opts_ranks <- list(
  ...
  "type" = c(type, list(tv_show_season = "10", "seriál - série" = "10")),

  "origin" = c(origin, list(
    "Evropa" = "continent-1",
    "Amerika" = "continent-2",
    "Asie" = "continent-3",
    "Afrika" = "continent-4",
  ...
  fields = list(actor = "actor", director = "director", Herci = "actor",
                "Režiséři" = "director")
)

usethis::use_data(opts_titles, opts_creators, opts_ranks, internal = TRUE, overwrite = TRUE)
